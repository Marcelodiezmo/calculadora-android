package com.example.a312c.calculadora;
...
public class MainActivity extends Activity {
    ...
    private Button _bLog;

    private int _valor;
    private int _operacion;
    private  double _valoropera;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        _bLog = (Button)findViewById(R.id.buttonLog);
        ...
        _bLog.setOnClickListener(lsBotonOperacion);
    ...
    private void opera()
    {
        switch (_operacion)
        {
            ...
            case 4: // seno
                try
                {
                     _valoropera = Math.sin(Math.toRadians(Double.parseDouble(_edit.getText().toString())));
                    _edit.setText(String.valueOf(_valoropera));
                }
                catch (Exception e)
                {
            ...
            case 5:    // coseno
                try
                {
                    _valoropera =  Math.toRadians(Double.parseDouble(_edit.getText().toString()));
                    _edit.setText(String.valueOf(Math.cos(_valoropera)));
                }
                catch (Exception e)
                {
...
//
            case 6:    // tangente
                try
                {
                    _valoropera =  Math.tan(Math.toRadians(Double.parseDouble(_edit.getText().toString())));
                    _edit.setText(String.valueOf(_valoropera));
                }
                catch (Exception e)
                {
            ...
            case 7:    // ln
                try
                {
                    _valoropera =  Math.log(Double.parseDouble(_edit.getText().toString()));
                    _edit.setText(String.valueOf(_valoropera));
                }
                catch (Exception e)
                {
